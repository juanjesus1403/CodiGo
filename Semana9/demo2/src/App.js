...
export default function App() {
  ...
  //useEffect(aca dentro una funcion), se dispara siempre que se monte el componenteo cambie un estado
  //solamente cuando cambie el contador o se monte mi componente
  useEffect(()=>{
